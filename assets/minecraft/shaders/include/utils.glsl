...
const vec3[] EP_COLORS = vec3[](
    vec3(0.110818 * 5, 0.098399 / 3, 0.022087),
    vec3(0.089485 * 5, 0.095924 / 3, 0.011892),
    vec3(0.100326 * 5, 0.101689 / 3, 0.027636),
    vec3(0.114838 * 5, 0.109883 / 3, 0.046564),
    vec3(0.097189 * 5, 0.117696 / 3, 0.064901),
    vec3(0.123646 * 5, 0.086895 / 3, 0.063761),
    vec3(0.166380 * 5, 0.111994 / 3, 0.084817),
    vec3(0.091064 * 5, 0.154120 / 3, 0.097489),
    vec3(0.195191 * 5, 0.131144 / 3, 0.106152),
    vec3(0.187229 * 5, 0.110188 / 3, 0.097721),
    vec3(0.148582 * 5, 0.138278 / 3, 0.133516),
    vec3(0.235792 * 5, 0.243332 / 3, 0.070006),
    vec3(0.214696 * 5, 0.142899 / 3, 0.196766),
    vec3(0.321970 * 5, 0.315338 / 3, 0.047281),
    vec3(0.302066 * 5, 0.390010 / 3, 0.204675),
    vec3(0.661491 * 5, 0.314821 / 3, 0.080955)
);
